	...
	if (($hakutuoteno != '' or $isatuoteno != '') and $tee == "") {
		...
		if (mysql_num_rows($result) == 1) {
			...
			elseif (mysql_num_rows($result) == 1) {
				...
				// Lapsirivit näytetään ilman hintoja
				...
				echo "	<select name='ei_nayteta'>
						...
						<option value='L' $sel3>".t("Lapsirivit näytetään ilman hintoja")."</option>
						</select></td>";
				...
				echo "<option value='K' $sel2>" . t("Kyllä") . "</option>";
				echo "</select>";
